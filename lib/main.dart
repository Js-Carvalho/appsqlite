...
import 'package:appsqlite/screens/CreditCardScreen.dart'; // Importar a nova tela
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    Widget _getPage(int index) {
      switch (index) {
        ...
        case 1:
          return CreditCardScreen(); // Tela de cartões de crédito
        default:
          return _userListView();
      }
    }
  ...
  // Função que retorna a lista de usuários
                ...
                IconButton(
                    onPressed: () {
                      Navigator.push(
                        ...
                        if (data != null) {
                          getAllUserDetails();
                          _showSuccessSnackBar('Usuário Alterado com Sucesso!');
                        }
                      });
                    },
                    icon: const Icon(
